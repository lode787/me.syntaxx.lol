const I18N = {
  en: {
    ...
    bio: "Cat person, code person. I build things for the fun of building them, whether anyone ends up using them or not. Music is non-negotiable, the harder the better: Tekk, Uptempo, that whole corner. I'm still working out what a portfolio is supposed to look like, but Syntaxx, Serene, and Rime got made in the meantime.",
    ...
    rime: "Music",
    rimeHint: "Music downloader. YouTube, Spotify, SoundCloud.",
  ...
  be: {
    ...
    bio: "Kattenmens, codemens. Ik bouw dingen voor het plezier van het bouwen, of iemand ze nu gebruikt of niet. Muziek is niet onderhandelbaar, hoe harder hoe beter: Tekk, Uptempo, heel dat hoekje. Ik zoek nog uit hoe een portfolio eruit hoort te zien, maar Syntaxx, Serene en Rime zijn er ondertussen al.",
    ...
    rime: "Muziek",
    rimeHint: "Muziekdownloader. YouTube, Spotify, SoundCloud.",
