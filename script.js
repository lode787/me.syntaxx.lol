const I18N = {
  en: {
    ...
    themeToLight: "White",
    themeToDark: "Dark",
    headline: "I build <em>Syntaxx</em>.",
    lede: "Belgian Discord bot. Moderation, economy, leveling, automod. The unglamorous stuff servers actually need.",
    bio: "I work in Cursor AI Pro. The cube graph below is those days, same calendar as <a href=\"https://cursor.com/@syntaxx\">cursor.com/@syntaxx</a>. I also made <a href=\"https://serene.fyi\">serene.fyi</a>, a private mood companion that never leaves your device. Syntaxx stays free. A coffee keeps the lights on.",
    cursorLove: "I love Cursor. Not as a slogan. I live in it. Syntaxx, Serene, this page: I ship them with Cursor AI Pro because it feels like a second pair of hands that already knows the repo. I would rather write with it than without it. Every single day.",
    invite: "Invite Syntaxx",
    coffee: "Buy a coffee",
    now: "Now",
    nowValue: "Shipping Syntaxx",
    based: "Based",
    basedValue: "Belgium",
    localTime: "Local time",
    graphTitle: "The days I ship in Cursor",
    graphLede: "GitHub-style cubes from my public Cursor profile, painted in this site's lilac. Live source: <a href=\"https://cursor.com/@syntaxx\">@syntaxx</a>.",
    longestStreak: "Longest streak",
    currentStreak: "Current streak",
    agents: "Agents",
    elsewhere: "Elsewhere",
    product: "Product",
    productHint: "The Discord bot. Invite, features, coffee.",
    also: "Also",
    alsoHint: "Private mood tracker. Nothing leaves the device.",
    cursorHint: "The official cube graph and streaks.",
    code: "Code",
    codeHint: "Bots, experiments, half-finished ideas.",
  ...
  be: {
    ...
    themeToLight: "Wit",
    themeToDark: "Donker",
    headline: "Ik bouw <em>Syntaxx</em>.",
    lede: "Belgische Discord-bot. Moderatie, economie, levels, automod. Het saaie werk dat servers écht nodig hebben.",
    bio: "Ik werk in Cursor AI Pro. De kubusgrafiek hieronder zijn die dagen, dezelfde kalender als <a href=\"https://cursor.com/@syntaxx\">cursor.com/@syntaxx</a>. Ik maakte ook <a href=\"https://serene.fyi\">serene.fyi</a>, een privé mood-app die je toestel nooit verlaat. Syntaxx blijft gratis. Een koffie houdt de lichten aan.",
    cursorLove: "Ik hou van Cursor. Geen slogan. Ik leef erin. Syntaxx, Serene, deze pagina: ik bouw ze in Cursor AI Pro omdat het voelt als een extra paar handen dat de repo al kent. Ik schrijf liever mét dan zonder. Elke dag opnieuw.",
    invite: "Syntaxx uitnodigen",
    coffee: "Koop een koffie",
    now: "Nu",
    nowValue: "Syntaxx aan het shippen",
    based: "Van",
    basedValue: "België",
    localTime: "Lokale tijd",
    graphTitle: "De dagen dat ik in Cursor ship",
    graphLede: "GitHub-kubussen van mijn publieke Cursor-profiel, in de lila van deze site. Live bron: <a href=\"https://cursor.com/@syntaxx\">@syntaxx</a>.",
    longestStreak: "Langste streak",
    currentStreak: "Huidige streak",
    agents: "Agents",
    elsewhere: "Elders",
    product: "Product",
    productHint: "De Discord-bot. Invite, features, koffie.",
    also: "Ook",
    alsoHint: "Privé mood-tracker. Niets verlaat je toestel.",
    cursorHint: "De officiële kubusgrafiek en streaks.",
    code: "Code",
    codeHint: "Bots, experimenten, half afgemaakte ideeën.",
    backToBot: "Terug naar de bot",
