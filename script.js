const I18N = {
  en: {
    ...
    lede: "22. Belgium. Born in Lier, aka Lierke Plezierke.",
    bio: "I love cats and I love coding. I make things even if nobody uses them. I would not live without music, especially Tekk and Uptempo. Still figuring out what belongs in a portfolio. Syntaxx and Serene are some of the things I shipped anyway.",
    cursorLove: "Music stays on. Cursor stays open. That is pretty much the setup.",
    email: "Email me",
    github: "GitHub",
    coffee: "Buy a coffee",
    now: "Age",
  ...
  be: {
    ...
    lede: "22. België. Geboren in Lier, aka Lierke Plezierke.",
    bio: "Ik hou van katten en van coderen. Ik maak dingen, ook als niemand ze gebruikt. Zonder muziek leef ik niet, vooral Tekk en Uptempo. Ik weet nog niet wat er in een portfolio hoort. Syntaxx en Serene zijn alvast dingen die ik toch gebouwd heb.",
    cursorLove: "Muziek blijft aan. Cursor blijft open. Dat is zo'n beetje de setup.",
    email: "Mail mij",
    github: "GitHub",
